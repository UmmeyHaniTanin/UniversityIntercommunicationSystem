...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="36" colspan="3" id="navigation" class="navText"> <a href="semester.php">SEMESTER</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  ...
	  &nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp; 
      <a href="adindex.php">ADMIN</a></td></td>
	<td width="40">&nbsp;</td>
	<td width="100%">&nbsp;
	...
	<td width="440" valign="top"><span class="style6"> &nbsp;&nbsp;&nbsp;</span><br />
	<br />
	<table border="0" cellspacing="0" cellpadding="0" width="441">
		<tr>
		<td width="441" class="pageName"><p>
		  <h1>Welcome To Admin Portal </h1> </p></td>
		</tr>

		<tr bgcolor="#a4c2c2">
		<td class="bodyText style7"><p> <span class="style7"><a href="file_upload_form.php">Upload</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  <a href="infodelete.php" class="style7">Delete</a>&nbsp;&nbsp;</p>
		  </td>
		</tr>
	</table>	
	<div class="style1">
...
<tr><td width="59">Id</td>
    <td width="165"><input  type="text" name="Id" value=""/></td></tr>
	<tr> <td></td> <td align=right><Button>Delete</Button>
