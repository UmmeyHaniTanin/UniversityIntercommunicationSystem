...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<p class="style7">Leave your message here </p>
<form id="form1" name="form1" method="post" action="contactsend.php">
  <p>
    <label>Name:
    ...
    <br />
    <span class="style1">
    <label>Message<span class="style5"><span class="style6">:</span><br />
